...
public record SemesterPlan(UniversitySubject[] subjects, SubjectRequirement[] subjectRequirements,
    ...
    public SemesterPlan {
        ...
        if (subjectRequirements == null) {
            throw new IllegalArgumentException("Subjects requirements array is null!");
        }
        if (minimalAmountOfCredits < 0) {
            throw new IllegalArgumentException("Minimal amount of credits enrolled for the category is negative!");
        }
    }
}
